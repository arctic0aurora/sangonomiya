...
def test_arlecchino(args=None):
    ...
    arlecchino = characters.pyro.arlecchino.ArlecchinoV0(constellation=0, weapon='crimson', virtual_artefact='whimsy', understanding='mult')
    arlecchino_path = './artefacts/test'
    optim = Optimizer(arlecchino, arlecchino_path, team=['yelan', 'zhongli', 'benette-noblesse'], args=[])
